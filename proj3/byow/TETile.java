...
public class TETile {
    ...
    public boolean equals(Object o) {
        ...
        TETile oTile = (TETile) o;
        if (this.character != oTile.character
                || this.textColor != oTile.textColor
                || this.backgroundColor != oTile.backgroundColor
                || this.description != oTile.description
                || this.filepath != oTile.filepath) {
            return false;
        }
        return true;
    }
